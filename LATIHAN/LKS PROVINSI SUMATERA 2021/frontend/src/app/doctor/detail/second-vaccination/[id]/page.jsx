...
export default function FirstVaccinationDetail() {
    ...
    const handleSubmit = async(e) => {
        ...
        try {
            ...
            const response = await axios.post(`http://localhost:8000/api/v1/doctor/second/${id}?token=${dataToken}`, formData);
    ...
    return (
        <div className="">
            ...
            <div className="font-poppins pt-28 px-32">
                <h1 className="font-[350] text-[48px]">Second Vaccination Society Detail</h1>
