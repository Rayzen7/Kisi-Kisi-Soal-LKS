...
--
-- Dumping data for table `installment_apply_societies`
--

INSERT INTO `installment_apply_societies` (`id`, `notes`, `available_month_id`, `date`, `society_id`, `installment_id`) VALUES
(40, 'Test', 47, '2025-08-12', 1, 16);
...
--
-- Dumping data for table `installment_apply_status`
--

INSERT INTO `installment_apply_status` (`id`, `date`, `society_id`, `installment_id`, `available_month_id`, `installment_apply_societies_id`, `status`) VALUES
(39, '2025-08-12', 1, 16, 47, 40, 'pending');
...
(5, '2025_02_15_040100_create_personal_access_tokens_table', 2);
...
(17, 'App\\Models\\Society', 1, 'access_token', 'cec07dd7045406f8e67f034fbba82475c6dfdba1b3c36f3ac8b38e19dfe0a685', '[\"*\"]', NULL, NULL, '2025-05-21 23:09:00', '2025-05-21 23:09:00');
...
(42, 1, 67, 'accepted', 'test', 'test', 120000, 'test', 'test');
